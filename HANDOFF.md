...
| | |
|---|---|
| Render service | ECS Fargate, cluster `roku-render`, 1–14 tasks under auto-scaling, ARM64 — displays leased to one task each via DynamoDB (OPS_RUNBOOK_DETAIL.md §9) |
