...
Every page background is device-drawn, one photo or many (2026-09-21;
the one-photo "stays baked" path failed in production twice). A lone
photo travels as a pair of itself with a one-day interval, because both
shipped clients start nothing below two images. This under-layer
