...
| "Connected. Loading your display..." after pairing | The code screen stayed up for the 10-15 s between the backend claim and the first page (Apple review rejection, 2026-09-25). onPaired now swaps the heading/code for Connected + Loading your display... with the spinner below; startPairing restores the code screen for a re-pair. No fallback text (Dave). | committed to live-portal, not yet on a device |
