# Mango Display TV platform — operations reference (full history and rationale)

The short runbook is `OPS_RUNBOOK.md`. This file keeps the long form: every decision, measurement and command as it was written, for when the short one is not enough.
