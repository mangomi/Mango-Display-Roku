sub init()
    ...
    m.overlayRegistry = { clock: "ClockOverlay", gif: "GifOverlay", scroll: "ScrollOverlay", motion: "MotionOverlay", slideshow: "SlideshowOverlay", countdown: "CountdownOverlay", background: "SlideshowOverlay" }
